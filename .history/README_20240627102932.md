<a href="https://chat.vercel.ai/">
  ...
  <h1 align="center">Bonat Agent</h1>
</a>
...
You can deploy your own version of the Bonat Agent to Vercel with one click:
...
You will need to use the environment variables [defined in `.env.example`](.env.example) to run Bonat Agent. It's recommended you use [Vercel Environment Variables](https://vercel.com/docs/projects/environment-variables) for this, but a `.env` file is all that is necessary.
